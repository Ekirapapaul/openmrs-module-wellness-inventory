 ...
 */
package org.openmrs.module.wellnessinventory.api;
...
/**
 * This is a unit test, which verifies logic in WellnessinventoryService. It doesn't extend
 * BaseModuleContextSensitiveTest, thus it is run without the in-memory DB and Spring context.
 */
public class WellnessinventoryServiceTest {
	
	@InjectMocks
	WellnessinventoryServiceImpl basicModuleService;
	
	@Mock
	WellnessinventoryDao dao;
